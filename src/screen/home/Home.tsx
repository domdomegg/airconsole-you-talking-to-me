    ...
    <>
      <div style={{ display: 'flex' }}>
        <div style={{ marginRight: '40px' }}>
          <svg xmlns="http://www.w3.org/2000/svg" height="250px" viewBox="0 0 92.4 99.2" version="1.1">
        ...
        <div style={{ textAlign: 'left' }}>
          <h1 style={{ fontSize: '100px' }}>You talking to <Highlight>me</Highlight>?</h1>
      ...
      <div style={{ marginTop: '20px' }}>
        <h2 style={{ fontSize: '50px', textAlign: 'center' }}>Players</h2>
        <ul>
